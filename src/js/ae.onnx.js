(function(global) {
    ...
    AE_ONNX.run = async function(imgData, modelName, config) {
        ...
        const logSettings = verbose ? { logSeverityLevel: 0, logVerbosityLevel: 0 } : { logSeverityLevel: 3, logVerbosityLevel: 3 };
        ...
        let session;
        let usedProvider = 'webgpu';
        
        try {
            onProgress("Init WebGPU...");
        ...
        onProgress(`Inference (${usedProvider})...`);
