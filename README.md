...
---
### After
! Please also note that this tool does not use any AI algorithm and vision model so its capabilities are limited to mathematical process natively running offline in your browser.
